...
public class formregister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 310, 90, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, 100, 40));
        ...
        tabelbarang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Jenis Kelamin", "Email", "Telepon", "Agama", "Alamat"
            }
        ));
        jScrollPane1.setViewportView(tabelbarang);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 380, 730, 110));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jTextField1.getText().equals("") ||jPasswordField1.getText().equals("") || laki.getText().equals("")|| email.getText().equals("")|| notelp.getText().equals("")|| agama.getSelectedItem().equals("")|| alamat.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "PT. Sentosa Anugerah", JOptionPane.INFORMATION_MESSAGE);
        }else{
        try {
            String sql ="delete from register where username='"+jTextField1.getText()+"'";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE  register SET password =  '" + jPasswordField1.getText() + "', jenis_kelamin='"+ jk +"' WHERE  username ='" + user + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
            ...
            alamat.setText("");
            jButton1.setEnabled(true);
            JOptionPane.showMessageDialog(null, "Data Berhasil Diubah", "KHANZA App", JOptionPane.INFORMATION_MESSAGE);
